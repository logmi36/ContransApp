...
public class Dta18 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj18.sqlite";
    private static final String TABLE_NAME = "obj18";

    public Dta18(Context _context)
    {
    ...
    public List<Obj18> ListbyId(String f05)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20 from " +TABLE_NAME + " where f05='"+f05+"' order by f00 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj18> items = new ArrayList<>();
        Obj18 item;
        Integer n=0;
    ...
    public Obj18 GetById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteByF05(String f05)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        //db.delete(TABLE_NAME,"f01 = ? ",new String[]{f01} );
        String sql="delete from " + TABLE_NAME + " where f05='"+f05+"';";
        db.execSQL(sql);
        db.close();
    }
