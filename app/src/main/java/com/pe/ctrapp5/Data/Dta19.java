...
public class Dta19 extends SQLiteOpenHelper {

    //notificaciones
    private static final int DB_VERSION = 6;
    private static final String DB_NAME = "obj19.sqlite";
    private static final String TABLE_NAME = "obj19";

    public Dta19(Context _context)
    {
    ...
    public List<Obj19> ListbyId(String f02)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20 from " +TABLE_NAME + " where f02='"+f02+"' order by f00 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj19> items = new ArrayList<>();
        Obj19 item;
        Integer n=0;
    ...
    public Obj19 GetById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteById(String f02)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        //db.delete(TABLE_NAME,"f01 = ? ",new String[]{f01} );
        String sql="delete from " + TABLE_NAME + " where f02='"+f02+"';";
        db.execSQL(sql);
        db.close();
    }
