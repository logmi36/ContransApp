...
public class Dta08 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj08.sqlite";
    private static final String TABLE_NAME = "obj08";

    public Dta08(Context _context)
    {
    ...
    public List<Obj08> ListById()
    {
        ...
        List<Obj08> items = new ArrayList<>();
        Obj08 item;
        Integer n=0;
    ...
    public Obj08 GetById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
