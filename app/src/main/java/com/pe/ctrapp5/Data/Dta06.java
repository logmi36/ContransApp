...
public class Dta06 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj06.sqlite";
    private static final String TABLE_NAME = "obj06";

    public Dta06(Context _context)
    {
    ...
    public List<Obj06> ListById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        List<Obj06> items = new ArrayList<>();
        Obj06 item;
        Integer n=0;
    ...
    public void deleteByF02(String f02)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        //db.delete(TABLE_NAME,"f01 = ? ",new String[]{f01} );
