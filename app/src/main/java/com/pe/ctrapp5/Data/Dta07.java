...
public class Dta07 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj07.sqlite";
    private static final String TABLE_NAME = "obj07";

    public Dta07(Context _context)
    {
    ...
    public List<Obj07> List(String txt, String email)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20 from " +TABLE_NAME + " where (f03 like '%"+txt+"%' or f05 like '%"+txt+"%') and f10='"+email+"' order by f00 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj07> items = new ArrayList<>();
        Obj07 item;
        Integer n=0;
    ...
    public void deleteByF10(String f10)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        //db.delete(TABLE_NAME,"f01 = ? ",new String[]{f01} );
        String sql="delete from " + TABLE_NAME + " where f10='"+f10+"';";
        db.execSQL(sql);
        db.close();
    }
