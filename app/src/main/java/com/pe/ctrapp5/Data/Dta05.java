...
public class Dta05 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj05.sqlite";
    private static final String TABLE_NAME = "obj05";

    public Dta05(Context _context)
    {
    ...
    public List<Obj05> ListById()
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20 from " +TABLE_NAME + " order by f00 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj05> items = new ArrayList<>();
        Obj05 item;
        Integer n=0;
    ...
    public Obj05 GetById(String f01, String f14)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20 from " +TABLE_NAME + " where f01='"+f01+"' and f14='"+f14+"' order by f00 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj05> items = new ArrayList<>();
        Obj05 item;
        Integer n=0;
    ...
    public Obj05 GetById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
