...
public class Dta15 extends SQLiteOpenHelper {


    //citas

    private static final int DB_VERSION = 2;
    private static final String DB_NAME = "obj15.sqlite";
    private static final String TABLE_NAME = "obj15";

    public Dta15(Context _context)
    {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sql="CREATE TABLE "+ TABLE_NAME + " (f00 INTEGER PRIMARY KEY AUTOINCREMENT, f01 TEXT,f02 TEXT,f03 TEXT,f04 TEXT,f05 TEXT,f06 TEXT,f07 TEXT,f08 TEXT,f09 TEXT,f10 TEXT,f11 TEXT,f12 TEXT,f13 TEXT,f14 TEXT,f15 TEXT,f16 TEXT,f17 TEXT,f18 TEXT,f19 TEXT,f20 TEXT,f21 TEXT,f22 TEXT,f23 TEXT,f24 TEXT,f25 TEXT)";
    ...
    public void insert(Obj15 item)
    {
        ...
        cv.put("f21", item.getF21());
        cv.put("f22", item.getF22());
        cv.put("f23", item.getF23());
        cv.put("f24", item.getF24());
        cv.put("f25", item.getF25());
        db.insert(TABLE_NAME,null,cv);
        db.close();
    }

    public List<Obj15> ListbyId(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25 from " +TABLE_NAME + " where f01='"+f01+"' order by f00 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj15> items = new ArrayList<>();
        Obj15 item;
        Integer n=0;
        while (cursor.moveToNext())
        {
            ...
            item.setF21(cursor.getString(20));
            item.setF22(cursor.getString(21));
            item.setF23(cursor.getString(22));
            item.setF24(cursor.getString(23));
            item.setF25(cursor.getString(24));
            items.add(item);
        }
        cursor.close();
    ...
    public Obj15 GetById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25 from " +TABLE_NAME + " where f01='"+f01+"'";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj15> items = new ArrayList<>();
        Obj15 item;
        Integer n=0;
