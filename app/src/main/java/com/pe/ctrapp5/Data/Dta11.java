...
public class Dta11 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj11.sqlite";
    private static final String TABLE_NAME = "obj11";

    public Dta11(Context _context)
    {
    ...
    public List<Obj11> ListById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        List<Obj11> items = new ArrayList<>();
        Obj11 item;
        Integer n=0;
    ...
    public Obj11 GetById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
