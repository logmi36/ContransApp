...
public class Dta09 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj09.sqlite";
    private static final String TABLE_NAME = "obj09";

    public Dta09(Context _context)
    {
    ...
    public List<Obj09> ListById(String f14)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20 from " +TABLE_NAME + " where f14='"+f14+"' order by f00 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj09> items = new ArrayList<>();
        Obj09 item;
        Integer n=0;
    ...
    public List<Obj09> ListByDocument(String f13)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20 from " +TABLE_NAME + " where f13='"+f13+"' order by f00 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj09> items = new ArrayList<>();
        Obj09 item;
        Integer n=0;
    ...
    public void deleteByF14(String f14)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        //db.delete(TABLE_NAME,"f01 = ? ",new String[]{f01} );
        String sql="delete from " + TABLE_NAME + " where f14='"+f14+"';";
        db.execSQL(sql);
        db.close();
    }

    public void deleteByF13(String f13)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String sql="delete from " + TABLE_NAME + " where f13='"+f13+"';";
        db.execSQL(sql);
        db.close();
    }
