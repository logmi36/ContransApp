...
public class Dta12 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj12.sqlite";
    private static final String TABLE_NAME = "obj12";

    public Dta12(Context _context)
    {
    ...
    public List<Obj12> List()
    {
        ...
        List<Obj12> items = new ArrayList<>();
        Obj12 item;
        Integer n=0;
    ...
    public Obj12 GetById(String f01)
    {
        SQLiteDatabase db = this.getWritableDatabase();
