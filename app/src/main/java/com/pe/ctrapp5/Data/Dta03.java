...
public class Dta03 extends SQLiteOpenHelper {


    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "obj03.sqlite";
    private static final String TABLE_NAME = "obj03";

    public Dta03(Context _context)
    {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sql="CREATE TABLE "+ TABLE_NAME + " (f01 INTEGER PRIMARY KEY AUTOINCREMENT, f02 TEXT,f03 TEXT,f04 TEXT,f05 TEXT,f06 TEXT,f07 TEXT,f08 TEXT,f09 TEXT,f10 TEXT,f11 TEXT,f12 TEXT,f13 TEXT,f14 TEXT,f15 TEXT,f16 TEXT,f17 TEXT,f18 TEXT,f19 TEXT,f20 TEXT)";
    ...
    public List<Obj03> ListById(String f02)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT f01, f02, f03, f04, f05, f06 ,f07,f08,f09,f10,f11,f12, f13, f14, f15, f16, f17, f18, f19, f20 from " +TABLE_NAME + " where f02='"+f02+"' order by f01 desc";
        Cursor cursor = db.rawQuery(query, null);
        List<Obj03> items = new ArrayList<>();
        Obj03 item;
        item=new Obj03();
        Integer n=0;
    ...
    public void deleteByMeeting(String f02)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_NAME,"f02 = ? ",new String[]{f02} );
        db.close();
    }
