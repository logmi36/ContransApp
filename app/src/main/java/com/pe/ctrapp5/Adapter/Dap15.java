...
public class Dap15 extends BaseAdapter {


    Context context;
    List<Obj09> items;

    public Dap15(Context context, List<Obj09> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        String p1 = getItem(i).getF04();
        String p2 = getItem(i).getF03();
        String p3 = getItem(i).getF12();
