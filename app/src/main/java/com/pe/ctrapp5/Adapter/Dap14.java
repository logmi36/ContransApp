...
public class Dap14 extends BaseAdapter {


    Context context;
    List<Obj14> items;

    public Dap14(Context context, List<Obj14> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        String p1 = getItem(i).getF02();
        String p2 = getItem(i).getF03();
        String p3 = getItem(i).getF05();
