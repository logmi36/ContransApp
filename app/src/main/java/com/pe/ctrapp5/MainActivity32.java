...
public class MainActivity32 extends AppCompatActivity {
    ...
    private SwipeRefreshLayout fr32r03;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(obj18.getF02());


        recyclerView = (RecyclerView) findViewById(R.id.fr32r01);
        fr32r03=(SwipeRefreshLayout) findViewById(R.id.fr32r03);
        ...
        fr32r03.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    public void onResume(){
        super.onResume();
        fr32r03.setRefreshing(false);

        Log.e("Activity====", "Activity 32");
    ...
    private void fnc02(String cod){
        ...
        DocItem item = new DocItem(cod, obj01.getF01(),obj18.getF02(),"","","");
    ...
    private void fnc03(List<Obj09> l9){
        ...
        dta09.deleteByF13(obj18.getF02());
